...
// export default function BlogPost( { event }: EventPageProps ) {
...
import TableOfContents from "@/components/table-of-contents"
import { PortableText } from "@portabletext/react"
import { urlFor } from "@/lib/sanity"  // ✅ important to import
      ...
      <main className="flex-1">
        <article className="container px-4 md:px-6 py-6 md:py-12 max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-gradient">{event.name}</h1>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:w-1/4">
              <div className="sticky top-20">
                {/* <TableOfContents content={event.sections} /> */}
              </div>
            </div>
          </div>
        </article>
